						...
						<ul>
							<?php
								...
								if (isset($_COOKIE["user_name"])){
									...
									echo "<li><a href=\"index.php\">登出</a></li>";
								}else {
										...
										<table class="alt">
											...
											<tbody>
												<?php
													...
													// 用SQL語法呼叫exec()
													$query = "SELECT * FROM `book_list` as a,`Records` as b WHERE a.`borrow_flag` = 1 and a.ID = b.ID";
													...
													foreach ($result as $row){
														...
														echo "<td><input type='button' value=\"還!\" name = \"ID\" onclick=\"user_check(". $row["ID"] .");\"></td>";
														echo "</tr>";
													}
												?>
											</tbody>
